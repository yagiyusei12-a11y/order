...
export const STORE_GAME_SAMPLES: StoreGameSampleDef[] = [
  ...
  },
  {
    ...
    winMode: "skill",
    winProbabilityPercent: 30,
    configJson: { pairCount: 7, maxMisses: 3, menuItemIds: [] },
    sortOrder: 3,
    rewardCount: 3,
  },
  {
  ...
  {
    slug: "order-history-quiz",
    kind: "tool",
    title: "注文履歴deクイズ",
    description:
      "今日この卓で頼んだメニューから自動で5問のクイズが出題。みんなで答え合わせて盛り上がろう！",
    iconEmoji: "🧾",
    playPriceYen: 0,
    winMode: "random",
    winProbabilityPercent: 0,
    configJson: { hubCategory: "tool" },
    sortOrder: 18,
    rewardCount: 0,
  },
  {
    ...
    title: "匿名ぶっちゃけアンケート",
    description:
      "「一番ロマンチストなのは？」などのお題に全員が匿名投票。結果はパーセンテージで表示され、犯人探しで盛り上がる！",
    iconEmoji: "🗳️",
    playPriceYen: 0,
    winMode: "random",
    winProbabilityPercent: 0,
    configJson: { hubCategory: "tool", maxPlayers: 16 },
    sortOrder: 19,
    rewardCount: 0,
  },
  {
