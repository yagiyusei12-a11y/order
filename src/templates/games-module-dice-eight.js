  ...
  window.__gameModules["dice-eight"] = {
    mount(ctx) {
      ...
      function renderDice(d1, d2, anim, opts) {
        ...
        const sumCls = showSum ? " dice-eight-sum show" : " dice-eight-sum";
        ...
        root.innerHTML =
          ...
          (rollMsg ? '<p class="dice-eight-roll-msg" id="diceRollMsg">' + rollMsg + "</p>" : "") +
          '<div class="dice-eight-row">' +
          '<div class="dice-eight-die' + a + r1 + '" id="die1">' + (d1 ? DICE_FACE[d1] : "?") + "</div>" +
          '<div class="dice-eight-die' + a + r2 + '" id="die2">' + (d2 ? DICE_FACE[d2] : "?") + "</div>" +
          "</div>" +
          (d1 && d2
